...
import 'package:helper/modules/life_cycle/app_life_cycle.dart';
...
import 'package:helper/modules/sample_screen/contacts_list.dart';
import 'package:helper/modules/search_filter/custom_search.dart';
import 'package:helper/modules/slider/slider_box.dart';
import 'package:helper/modules/tab_bar/tab_bar_and_tab_view.dart';
...
import 'package:helper/shared/screens/test_screen.dart';
import 'package:helper/shared/shared.dart';
import 'package:helper/shared/widgets/app_drawer.dart';
import 'package:helper/shared/widgets/app_scaffold.dart';
...
final List<Screens> screens = [
  Screens(title: 'Animations', child: const HeroAnimation()),
  ...
  Screens(title: 'AppCycle', child: const AppLifeCycle()),
  ...
  Screens(title: 'Sample Screen', child: const ContactsList()),
  ...
  Screens(title: 'Test Screens', child: const TestScreen()),
  Screens(title: 'TabBar', child: const TabBarAndTabViews()),
