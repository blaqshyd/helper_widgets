...
class CommentPainter extends StatefulWidget {
  const CommentPainter({super.key});

  @override
  State<CommentPainter> createState() => _CommentPainterState();
}

class _CommentPainterState extends State<CommentPainter> {
  @override
